...
import { ProjectSelectorSkeleton } from './Skeleton'
...
export const ProjectSelector = ({ projects, selectedId, handleChange, isLoading = false }: ProjectSelctorProps) => {
    ...
    return (
        <>
            {isLoading ? (
                ...
                projects.length > 0 && (
                    <ToggleNav title="본선 진출작 목록" isOpen={isOpen} setIsOpen={setIsOpen}>
